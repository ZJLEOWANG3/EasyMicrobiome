...
#                 meta="../data/CROPPS2022Summer16S/metadata_wheat_v1.xlsx")
# projlist = list(projname = "Winter_Wheat_genus",
#                 groupcol = c("Timepoint","Plot..Name."), #all () and space will become .
#                 sheetindex = 1, # first sheet
#                 endRow = 44) # how many rows within the metadata excel


# set name - T1 and T4 wheat dataset
pathlist = list(abundance="../data/CROPPS2022Summer16S/abundance/genus.tsv",
                meta="../data/CROPPS2022Summer16S/metadata_wheat_v2.xlsx")
projlist = list(projname = "Winter_Wheat_genus_T1T4",
                groupcol = c("Timepoint","Plot..Name."), #all () and space will become .
                sheetindex = 1, # first sheet
                endRow = 20) # how many rows within the metadata excel
```
