...
sort.tf = "unsort" # sort, unsort, all
if (sort.tf=="sort"){
...
pathlist = list(abundance=paste("../data/ZhouSoil16S/Old/abundance/",
                                tax.level,".tsv",sep=""),
                meta="../data/ZhouSoil16S/Old/metadata2.xlsx")
projlist = list(projname = paste("ZhouSoil16S_Old_",sort.tf,"_",tax.level,sep=""),
...
for (temp.col in projlist$groupcol){
  ...
  p<-plot_anova_diversity(physeq,
                          method = method,# c("richness","simpson", "shannon"),
